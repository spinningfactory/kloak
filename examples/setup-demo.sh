...
check_prereqs() {
    ...
    for cmd in limactl kubectl docker helm; do
...
# Deploy Kloak components using Helm chart
deploy_kloak() {
    export KUBECONFIG="$KUBECONFIG_PATH"
    echo ""
    echo "Deploying Kloak using Helm chart (auto-cert mode)..."
    ...
    echo "✓ Kloak deployed (controller DaemonSet, webhook)"
}
...
show_summary() {
    ...
    echo "  Helm chart:          $ROOT_DIR/charts/kloak"
    echo ""
    echo "Commands:"
